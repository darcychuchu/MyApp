...
import com.vlog.my.data.repository.UserRepository
    ...
    fun checkUsername(username: String) {
        ...
        viewModelScope.launch {
            try {
                ...
                android.util.Log.d("UserViewModel", "Username check response: code=${response.code}, data=${response.data}, message=${response.message}")
                // 处理可能的null值
    ...
    fun checkNickname(nickname: String) {
        ...
        viewModelScope.launch {
            try {
                ...
                android.util.Log.d("UserViewModel", "Nickname check response: code=${response.code}, data=${response.data}, message=${response.message}")
                // 处理可能的null值
                if (response.data != null) {
